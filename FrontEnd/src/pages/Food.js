...
import { Header , Footer, FoodMenu, SearchContainer, FoodKeyword,
...
function Food({userInfo}){
    ...
    let foodPlaceholder = '가게명을 입력해주세요'
    return(
       <>
        <Header></Header>
        <div className="food-container">
            <div className="food-contents">
                ...
                <div className="food-body">
                    ...
                    <SearchContainer keywordSearch={keywordSearch} placeholder={foodPlaceholder}></SearchContainer>
                    {!loadState ? 
